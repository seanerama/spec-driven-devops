/**
 * Roles — Role registry and metadata for all SDD roles
 */
...
const ROLES = {
  'vision-assistant': {
    ...
    outputs: ['sdd-output/vision-document.md'],
    paths: ['new'],
    optional: true,
    depends_on: [],
  ...
  'lead-architect': {
    ...
    outputs: ['sdd-output/project-plan.md', 'sdd-output/deploy-instruct.md'],
    paths: ['new'],
    optional: false,
  ...
  'ui-ux-designer': {
    ...
    outputs: ['sdd-output/design-system.md'],
    paths: ['new'],
    optional: true,
    depends_on: [],
    blocks: [],
  ...
  'retrofit-planner': {
    ...
    outputs: ['sdd-output/project-plan.md', 'sdd-output/project-state.md'],
    paths: ['existing'],
    optional: false,
    depends_on: [],
    blocks: ['project-planner'],
  ...
  'project-planner': {
    ...
    outputs: ['sdd-output/stage-instructions/', 'sdd-output/contracts/'],
    paths: ['new', 'existing'],
    optional: false,
  ...
  'feature-manager': {
    ...
    outputs: ['sdd-output/feature-assessments/'],
    paths: ['new', 'existing'],
    optional: true,
    depends_on: ['project-planner'],
    blocks: [],
  ...
  'handoff-tester': {
    ...
    outputs: ['sdd-output/ux-feedback/'],
    paths: ['new', 'existing'],
    optional: true,
    depends_on: ['stage-manager'],
    blocks: [],
  ...
  'security-auditor': {
    ...
    outputs: ['sdd-output/security-report.md'],
    paths: ['new', 'existing'],
    optional: true,
    depends_on: ['stage-manager'],
    blocks: [],
